...
export const ACTIVITIES = [
  "Adminisztráció","Belső egyeztetés","Közbeszerzés / ajánlat","Kreatív / design",
  "Médiatervezés / -vásárlás","Rendezvényszervezés","Riport / elemzés","Sajtókapcsolat / monitoring",
  "Sajtóközlemény","Social media / tartalom","Stratégia / tervezés","Ügyfél-egyeztetés",
  "Videó / gyártás","Egyéb"
];
